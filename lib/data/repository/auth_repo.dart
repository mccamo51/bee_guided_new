...
class AuthRepo {
  ...
  Future<Response> registration(Object signUpBody) async {
    return await apiClient.postData(AppConstants.REGISTER_URI, signUpBody);
  }
  ...
  Future<Response> registerWithSocialMedia(Object socialLogInBody) async {
    return await apiClient.postData(AppConstants.SOCIAL_REGISTER_URL, socialLogInBody);
  }
